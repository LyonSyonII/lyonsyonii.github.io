...
export function getInitialTheme(themeConfig: ThemeConfig) {
...
export function isDarkishTheme(theme: string) {
  return ["dark", "halloween", "forest", "black", "luxury", "dracula"].includes(theme);
}

export function sanitizeConfig(config: RawConfig): SanitizedConfig {
...
export const tooManyRequestError = (reset: any) => ({
  status: 429,
